<?php
    require_once "../admin/assets/css/libs_css.php";
    ?>
...
<body>
    ...
    <div id="layout-wrapper">
        ...
        <!-- HEADER -->
        <?php
        require_once "../admin/views/layouts/header_siderbar/header.php";
        require_once "../admin/views/layouts/header_siderbar/siderbar.php";
        ?>
    ...
    <!-- JAVASCRIPT -->
    <?php
    require_once "../admin/assets/js/libs_js.php";
    ?>
